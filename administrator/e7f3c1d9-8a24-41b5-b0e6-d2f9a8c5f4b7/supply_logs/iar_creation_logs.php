...
<div class="row">
        <div class="col-md-12">
            <h3 class="mb-3">IAR Creation Trail</h3>
            <div class="table-responsive">
            <table id="iarcreationlogsTable" class="table table-striped" style="table-layout: fixed;">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM iar_creation_trail ORDER BY created_at DESC";
