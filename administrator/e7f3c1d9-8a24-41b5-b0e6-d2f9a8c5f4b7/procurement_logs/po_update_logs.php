...
<main class="container mt-5 custom-container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="mb-3">PO Update Trail</h3>
            <div class="table-responsive">
            <table id="poupdatelogsTable" class="table table-striped" style="table-layout: fixed;">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM po_update_trail ORDER BY updated_at DESC";
