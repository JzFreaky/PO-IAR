...
<main class="container mt-5 custom-container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="mb-3">PO Creation Trail</h3>
            <div class="table-responsive">
            <table id="pocreationlogsTable" class="table table-striped" style="table-layout: fixed;">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM po_creation_trail ORDER BY created_at DESC";
