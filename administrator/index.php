...
require "../administrator/authenticate.php";
?>
...
<div class="login-container">
        <div class="login-box">
            <div class="login-left">
                ...
                <img src="css/image/depositphotos_28656857-stock-photo-office-administrator-job-duties-meeting.jpg" alt="Student Portal" class="background">
            </div>
            ...
            <?php if (!empty($message)) : ?>
                ...
                <form action="" method="post">
                    ...
                    <input type="text" id="student_id" name="username" required>
