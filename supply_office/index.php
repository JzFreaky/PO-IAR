...
require "../supply_office/authenticate.php";
?>
<title>Supply Office Portal</title>
<div class="login-container">
        <div class="login-box">
            <div class="login-left">
                <img src="css/image/IMG_8354_2-1-1-1536x863.jpg" alt="Student Portal" class="whole_background">
                <img src="css/image/01EPCIC Contract Management in Offshore and Marine_1616269518.jpg" alt="Student Portal" class="background">
            </div>
            <div class="login-right">
            <?php if (!empty($message)) : ?>
                    <div class="error-message"><?php echo $message; ?></div>
                    <?php endif; ?>
                <h1>SUPPLY OFFICE PORTAL</h1>
