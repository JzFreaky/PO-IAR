    ...
    <table id="iarTable" class="table table-striped table-bordered" style="table-layout: fixed;">
        ...
        <?php if (!empty($allIARs)): ?>
                <?php foreach ($allIARs as $iar): ?>
                    <tr <?php if ($iar['saiar_new'] == 1) { echo 'class="pulsing-color"'; } ?>>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $iar['id']; ?>">
                                    <a class="dropdown-item ai-dropdown-item" href="view_iar.php?id=<?php echo $iar['id']; ?>&update_saiar=1"><i class="fas fa-eye view-icon"></i> View </a>
                                </div>
                            </div>
                        </td>
                    </tr>
