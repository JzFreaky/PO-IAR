...
require '../../class/function/property_config.php';
    ...
    <table class="info-table">
        <tr>
            ...
            <td><strong>Delivery Term:</strong> 
                <span class="underline-word"><?php echo htmlspecialchars(date('M d, Y', strtotime($order['date_delivery']))); ?></span>
            </td>
        </tr>
        <tr>
...
<table class="info-table">
        ...
        <tr>
            ...
            <td><strong>Date of the ORS/BURS:</strong> 
                <span class="underline-word"><?php echo htmlspecialchars(date('M d, Y', strtotime($order['ors_burs_date']))); ?></span>
            </td>
        </tr>
        <tr>
        <td>
...
<div class="d-flex justify-content-between mt-3">
    <a href="../purchase_order/" class="btn btn-secondary"><i class="fas fa-arrow-left"></i></a>
    <a href="#" class="btn btn-secondary ml-auto" data-toggle="modal" data-target="#deliveryHistoryModal">
