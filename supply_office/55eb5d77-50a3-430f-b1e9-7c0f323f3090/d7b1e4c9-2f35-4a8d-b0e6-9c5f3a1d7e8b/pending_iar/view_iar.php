...
?>
<title>View Inspection and Acceptance Report</title>
...
<div class="iar-details">
    ...
    <table class="item-table">
        ...
        <?php 
            $counter = 1;
            $hasRemarks = false; // Flag to check for remarks
            ...
            ?>
                ...
                <?php foreach ($specifications as $specification): ?>
                    <tr>
                        <td></td>
                        <td colspan="1" style="text-align: left;"><?php echo htmlspecialchars($specification); ?></td>
                        <td></td>
                        <td></td>
                    </tr>
                <?php endforeach; ?>
...
<?php endif; ?>
        <a class="btn btn-primary mt-3" href="update_iar.php?id=<?php echo $iar['id']; ?>"><i class="fas fa-clipboard-check"></i> Check</a>
    <?php else: ?>
