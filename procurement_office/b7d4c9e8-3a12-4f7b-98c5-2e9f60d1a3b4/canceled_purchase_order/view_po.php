...
?>
<title>Canceled Purchase Order</title>
...
<div class="d-flex justify-content-between align-items-center">
    <a href="../canceled_purchase_order/" class="btn btn-secondary mt-3"><i class="fas fa-arrow-left"></i></a>
    <div>
    ...
    <a href="view_pdfpo.php?id=<?php echo $order['id']; ?>" class="btn btn-primary mt-3"><i class="fas fa-print"></i> Print</a>
        <?php if ($order['status'] === 'pending'): ?>
            <form method="POST" action="../classes/config.php" style="display: inline-block;">
                <input type="hidden" name="po_id" value="<?php echo $order['id']; ?>">
                <button type="submit" name="approve_po" class="btn btn-success mt-3"><i class="fa-sharp-duotone fa-solid fa-forward"></i>  Forward</button>
            </form>
        <?php endif; ?>
    </div>
</div>
